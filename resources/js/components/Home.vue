...
export default {
    ...
    computed:{
        toLogin(){ return this.$store.state.toLogin }
    },
    methods:{
        toggleToLogin(){
...
background: linear-gradient(90deg, rgba(43,37,1,0.9224732129179797) 0%,
        rgba(187,159,0,1) 15%, rgba(29,25,1,0.9252743333661589) 89%);
