          ...
          <div class="form mt-4">
            <form action="#">
              ...
              <div class="form-group">
                ...
                >Using a good and descriptive image gives your business a good visual impression.</small>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  required
                  :class="{ 'is-invalid': form.errors.has('value_proposition') }"
                ></textarea>
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  required
                  :class="{ 'is-invalid': form.errors.has('customer_segment') }"
                ></textarea>
              ...
              <div class="form-group">
                ...
                <textarea
                  id="key_resources"
                  class="form-control"
                  v-model="form.key_resources"
                  required
                  :class="{ 'is-invalid': form.errors.has('key_resources') }"
                ></textarea>
...
export default {
  ...
  methods: {
    fetchState() {
      let url = "https://locationsng-api.herokuapp.com/api/v1/states";
      axios
        .get(url)
        .then(res => {
    ...
    fetchCity() {
      let url = `https://locationsng-api.herokuapp.com/api/v1/states/${this.form.location}/lgas`;
      axios
        .get(url)
        .then(res => {
    ...
    addBusiness() {
      ...
      this.form
        ...
        .then(response => {
          ...
          this.$router.push("/dashboard/1/businesses");
        })
        .catch(err => {
